...
const PurchaseDetlsForm = ({
  ...
  const update_ItemDetls = data => {
    ...
    setValue('pl_itemno', item_no);
    setValue('pl_desp', item_desp);
    setValue('pl_packing', item_packing);
    setValue('pl_unit', item_unit);
    setValue('pl_ucost', item_ucost_pc);
    setValue('pl_netucost', item_ucost_pc);
    setQty(prev => prev = 0)
            ...
            <GridItem colSpan={9} mt={field_gap}>
              <FormControl>
                <Controller
                  control={control}
                  name="pl_netucost"
                  defaultValue={state.pl_netucost}
                  render={({ field: { onChange, value, ref } }) => (
                    <InputGroup>
                      <HStack w="100%" py={1}>
                        <InputLeftAddon
...
export default PurchaseDetlsForm;
