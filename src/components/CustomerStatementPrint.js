...
const BillTo = ({ doc, pageno, totalpage }) => (
  <View style={headerstyles.colContainer}>
    ...
    <View style={headerstyles.rowContainer}>
      <Text style={headerstyles.billtofield}>{doc.ar_cust}</Text>
      <Text style={headerstyles.doclabel}>Date:</Text>
      <Text style={headerstyles.docfield}>{doc.ar_date}</Text>
    </View>
    <View style={headerstyles.rowContainer}>
    ...
    <Text style={headerstyles.billtofield}>{doc.ar_add4}</Text>
  </View>
);
...
const InvoiceTableHeader = () => (
  <View style={tablestyles.container}>
    ...
    <Text style={tablestyles.paidamt}>Paid Amt</Text>
...
const InvoiceTableRow = ({ items }) => {
  ...
  const rows = items.map((item, index) => (
    <View style={tablerowstyles.row} key={index}>
      ...
      <Text style={tablerowstyles.amount}>{item.ar_total}</Text>
      <Text style={tablerowstyles.paidamt}>{item.ar_paid_amt}</Text>
      <Text style={tablerowstyles.balance}>{item.ar_balance}</Text>
    </View>
  ));
  return <>{rows}</>;
};
...
const InvoiceItemsTable = ({ items, total, lastpage }) => (
  <View style={itemsstyles.tableContainer}>
    ...
    {lastpage ? <InvoiceTableFooter items={items} /> : null}
  </View>
);
...
const AgingTable = ({ items, total, lastpage }) => (
  <View style={itemsstyles.tableContainer}>
    <AgingTableHeader />
    <AgingTableRow />
  </View>
...
const AgingTableHeader = () => (
  <View style={agingstyles.container}>
    <Text style={agingstyles.days120}>Over 120 Days</Text>
    <Text style={agingstyles.days90}>91 - 120 Days</Text>
...
const AgingTableRow = () => (
  <View style={agingrowstyles.container}>
    <Text style={agingrowstyles.days120}>Over 120 Days</Text>
    <Text style={agingrowstyles.days90}>91 - 120 Days</Text>
    <Text style={agingrowstyles.days60}>61 - 90 Days</Text>
    <Text style={agingrowstyles.days30}>31 - 60 Days</Text>
    <Text style={agingrowstyles.current}>Current</Text>
    <Text style={agingrowstyles.total}>Total Due</Text>
  </View>
);

const CustomerStatementPrint = () => {
  ...
  //console.log('ar stat', batchdetls);
