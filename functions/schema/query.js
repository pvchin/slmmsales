  ...
  fields: {
    documentno: {
      ...
      resolve(parentValue, args) {
        const query = `SELECT * FROM dbo_documentno where doc_branch=$1`;
    ...
    itemsHistoryByItem: {
      ...
      resolve(parentValue, args) {
        const query = `SELECT * FROM dbo_items_history WHERE it_itemno=$1 and it_branch=$2`;
        const values = [args.itemno, args.branch];
    ...
    user: {
      ...
      resolve(parentValue, args) {
        const query = `SELECT * FROM systemusers WHERE userid=$1`;
    ...
    allUsers: {
      ...
      args: {},
      resolve(parentValue, args) {
        const query = `SELECT * FROM systemusers`;
    ...
    account: {
      type: AccountType,
      args: { no: { type: GraphQLID } },
      resolve(parentValue, args) {
        const query = `SELECT * FROM dbo_account WHERE acc_code=$1`;
        const values = [args.no];
    ...
    allAccounts: {
      ...
      args: {},
      resolve(parentValue, args) {
        const query = `SELECT * FROM dbo_account`;
    ...
    trans: {
      ...
      args: { id: { type: GraphQLID } },
      resolve(parentValue, args) {
        const query = `SELECT * FROM dbo_trans WHERE t_id=$1`;
        const values = [args.id];
    ...
    allTransByBranch: {
      ...
      args: { branch: { type: GraphQLString } },
      resolve(parentValue, args) {
        const query = `SELECT * FROM dbo_trans where t_branch = $1 order by t_no desc`;
        const values = [args.branch];
    ...
    allTransByBatchno: {
      type: new GraphQLList(TransType),
      args: {
        batchno: { type: GraphQLString },
      },
      resolve(parentValue, args) {
        const query = `SELECT * FROM dbo_trans where t_no=$1`;
        const values = [args.batchno];
    ...
    allTransDetlsByBranch: {
      type: new GraphQLList(TransDetlsType),
      args: { branch: { type: GraphQLString } },
      resolve(parentValue, args) {
        const query = `SELECT * FROM dbo_transitems where tl_branch=$1 order by tl_itemno`;
        const values = [args.branch];
    ...
    allTransDetlsByTranNo: {
      ...
      resolve(parentValue, args) {
        const query = `SELECT * FROM dbo_transitems where tl_tranno=$1 and tl_branch=$2 order by tl_itemno`;
        const values = [args.tranno, args.branch];
    ...
    transadjust: {
      ...
      args: { id: { type: GraphQLID } },
      resolve(parentValue, args) {
        const query = `SELECT * FROM dbo_transadj WHERE ta_id=$1`;
        const values = [args.id];
    ...
    allTransadjustByBranch: {
      type: new GraphQLList(TransAdjustType),
      args: { branch: { type: GraphQLString } },
      resolve(parentValue, args) {
        const query = `SELECT * FROM dbo_transadj where ta_branch=$1 order by ta_batchno desc`;
        const values = [args.branch];
    ...
    allTransadjustDetlsByBranch: {
      type: new GraphQLList(TransAdjustDetlsType),
      args: { branch: { type: GraphQLString } },
      resolve(parentValue, args) {
        const query = `SELECT * FROM dbo_transadj_detls where tad_branch=$1 order by tad_batchno`;
        const values = [args.branch];
        return db
          .many(query, values)
          .then(res => res)
    ...
    allTransadjustDetlsByTranno: {
      ...
      resolve(parentValue, args) {
        const query = `SELECT * FROM dbo_transadj_detls where tad_batchno=$1 and tad_branch=$2 order by tad_itemno`;
        const values = [args.tranno, args.branch];
        return db
          .many(query, values)
          .then(res => res)
