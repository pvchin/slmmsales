...
export function useAddTransadjust(data) {
  ...
  const { mutate } = useMutation({
    ...
    onSuccess: () => {
      Toast({
        title: 'New Adjust Transaction being added!',
        status: 'success',
        customId: 'tranadjustAdd',
      });
    },
    onError: () => {
      Toast({
        title:
          'Adjust Transaction Add Error! Please check your internet connection!',
        status: 'warning',
